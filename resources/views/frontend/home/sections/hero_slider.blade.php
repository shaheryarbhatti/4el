{{-- Home section: hero_slider (from Porto demo36). Managed in Admin > Pages > Home Sections. --}}
<div class="bg-gray pb-5"><div class="container pb-3">
                    <div class="home-slider slide-animate owl-carousel owl-theme nav-circle mb-2" data-owl-options="{
				'loop': false
			}">
                        <div class="home-slide home-slide1 banner">
                            <img class="slide-bg" src="/frontend-assets/images/demoes/demo36/slider/slide-1.jpg" alt="slider image">
                        ...
                        <div class="home-slide home-slide2 banner banner-md-vw">
                            <img class="slide-bg" src="/frontend-assets/images/demoes/demo36/slider/slide-2.jpg" alt="slider image">
