...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        @php $adminLogo = setting('admin_logo') ? asset('storage/'.setting('admin_logo')) : null; @endphp
        <a href="{{ route('admin.dashboard') }}" class="header-logo">
            <img src="{{ $adminLogo ?? asset('admin-assets/images/brand-logos/desktop-logo.png') }}" alt="logo" class="desktop-logo">
            <img src="{{ asset('admin-assets/images/brand-logos/toggle-logo.png') }}" alt="logo" class="toggle-logo">
            <img src="{{ $adminLogo ?? asset('admin-assets/images/brand-logos/desktop-dark.png') }}" alt="logo" class="desktop-dark">
